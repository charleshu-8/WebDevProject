...
export default function SideBar () {
  ...
  /* defines parameter type for props passed to SidePanel */
  interface PanelProps {
    panel: Panel;
  }
  function SidePanel (panel: PanelProps) {
    ...
    */
    ...
    return(
        <Box className="bg-light-secondary flex flex-col h-full w-[20vw] min-w-[10rem] p-2 dark:bg-dark-background">
            <Box className="flex justify-start w-full h-auto">
                <h2 className="panel-title text-black w-auto h-auto m-2">{panelTitle}</h2>
            </Box>
