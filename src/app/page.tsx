...
export default function Home() {
  return (
    <div className="h-screen w-screen flex flex-col bg-[#FAFCFF]  dark:bg-[#073269]">
      <main className="text-[#030C17] font-roboto">
        <div className="h-[150px] bg-[#FAFCFF]">
          <div className="absolute right-0 z-10">
            <svg xmlns="http://www.w3.org/2000/svg" width="883" height="150" viewBox="0 0 883 150" fill="none">
          ...
          <div className="z-20 absolute top-[66px] right-[300px] font-bold text-[#E8F1FC]">
